                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="piva" type="text" class="form-control @error('piva') is-invalid @enderror"
                                        name="piva" value="{{ old('piva') }}" required minlength="11" maxlength="11"
                                        autofocus>
                            ...
                            <div class="form-group row">
                                <label for="category"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Categoria/e *') }}</label>

                                <div class="col-md-6">
                                    {{-- Nell'input di tipo select multiple aggiung [] a name per passare un array --}}
                                    <select id="categories" type=""
                                        class="form-control @error('categories') is-invalid @enderror" name="categories[]"
                                        value={{ json_encode($categories, true) }} required autocomplete="category"
                                        autofocus multiple maxlength='40'>
                            ...
                            <div class="form-group row">
                                <label for="restaurant_image" class="col-md-4 col-form-label text-md-right">Immagine del
                                    Ristorante *</label>
                                <div class="col-md-6">
                                    <input type="file" class="@error('restaurant_image') is-invalid @enderror "
                                        name="restaurant_image" id="restaurant_image"
                                        aria-describedby="restaurant_imageHelperr" placeholder="Aggiungi un'immagine"
                                        required />
                                ...
                                <small id="restaurant_imageHelperr" class="form-text text-muted col-md-6 offset-md-4">Una
                                    volta inserita un'immagine non potrà più essere modificata</small>
                            </div>
