...
>>>>>>> 9a2feff70562ae1b4c39a8f64fe79d010cc9de3b
                                    <div class="description">
                                        ...
                                        <div class="button">
                                            <i class="fa fa-plus plus ml-2" aria-hidden="true"
                                                @click="addToCart(dish, {{ $user->id }})"></i>
                                        </div>
                                    </div>
                                    <div class="dish_image"
                                        :style="{ backgroundImage: 'url(\'storage/' + dish.image + '\')' }"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container position-relative h-100">
                    <div class="row sticky-top mx-0">
                        <div class="col-12 cart position-relative">
                            <div v-if="cart.length > 0 && cart[0].user_id == {{ $user->id }}"
                                class="text-white cart-title d-flex align-items-center justify-content-center col-12 px-0 position-absolute">
                            ...
                            <ul class='px-0 mb-0' v-if="cart.length > 0 && cart[0].user_id == {{ $user->id }}">
                                    ...
                                    <div class="row d-flex justify-content-around">
                                        <div class="col-3 col-md-4 col-lg-3 py-1 px-0">
                                            <i class="fa fa-minus-circle" aria-hidden="true"
                                                @click="removeFromCart(dish,index)"></i>
                                ...
                                <li>
                                    <div class="row">
                                        <div
                                            class="col-sm-3 offset-sm-7 col-md-6 col-lg-4 offset-md-2 offset-lg-5 py-1 total_price">
                                            <h3>Totale: </h3>
                                        </div>
                            ...
                            <a href="{{ route('orders.create', $user->id) }}"
                                class="btn active btn-brand-secondary text-white btn-block"
                                v-if="cart.length > 0 && cart[0].user_id == {{ $user->id }}">Vai alla cassa</a>
                            <button disabled class="btn btn-brand-secondary text-white btn-block" v-else>Vai alla
                                cassa</button>
                            <div class=" text-center mt-2 "
                                v-if="cart.length > 0 && cart[0].user_id == {{ $user->id }}">
